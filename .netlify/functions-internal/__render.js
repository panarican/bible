		...
		(function (module2, exports) {
			(function (global2, factory) {
				...
				function WritableStreamAbort(stream, reason) {
					...
					(_a2 = stream._writableStreamController._abortController) === null || _a2 === void 0
						? void 0
						: _a2.abort();
	...
	'node_modules/.pnpm/tslib@2.3.1/node_modules/tslib/tslib.js'(exports, module2) {
		...
		(function (factory) {
			...
			__rest2 = function (s2, e) {
				var t = {};
				for (var p2 in s2)
					if (Object.prototype.hasOwnProperty.call(s2, p2) && e.indexOf(p2) < 0) t[p2] = s2[p2];
			...
			__asyncDelegator2 = function (o2) {
				...
				function verb(n, f) {
					i2[n] = o2[n]
						? function (v2) {
								return (p2 = !p2)
									? { value: __await2(o2[n](v2)), done: n === 'return' }
									: f
									? f(v2)
									: v2;
						  }
			...
			__asyncValues2 = function (o2) {
				...
				return m2
					? m2.call(o2)
					: ((o2 = typeof __values2 === 'function' ? __values2(o2) : o2[Symbol.iterator]()),
					  (i2 = {}),
					  verb('next'),
					  verb('throw'),
					  verb('return'),
...
function safe_not_equal$1(a2, b2) {
	return a2 != a2
		? b2 == b2
		: a2 !== b2 || (a2 && typeof a2 === 'object') || typeof a2 === 'function';
}
Promise.resolve();
							...
							async function text() {
								...
								if (!opts.body || typeof opts.body === 'string') {
									fetched.push({
										url,
										body: opts.body,
										json: `{"status":${response2.status},"statusText":${s$2(
											response2.statusText
										)},"headers":${s$2(headers)},"body":"${escape_json_string_in_html(body)}"}`
									});
								}
								return body;
							}
...
function init(settings = default_settings) {
	...
	options = {
		...
		dev: false,
		entry: {
			file: assets + '/_app/start-4ddef9fe.js',
			css: [assets + '/_app/assets/start-61d1577b.css'],
			js: [assets + '/_app/start-4ddef9fe.js', assets + '/_app/chunks/vendor-c74264e5.js']
		},
		fetched: void 0,
		floc: false,
...
var manifest = {
	assets: [
		{ file: '.DS_Store', size: 6148, type: null },
		{ file: 'android-chrome-192x192.png', size: 2410, type: 'image/png' },
		{ file: 'android-chrome-384x384.png', size: 4988, type: 'image/png' },
		{ file: 'apple-touch-icon.png', size: 2216, type: 'image/png' },
		{ file: 'assets/.DS_Store', size: 6148, type: null },
		{ file: 'assets/images/chevron-left.svg', size: 263, type: 'image/svg+xml' },
		{ file: 'assets/images/chevron-up.svg', size: 261, type: 'image/svg+xml' },
		{ file: 'assets/images/heart-fill.svg', size: 364, type: 'image/svg+xml' },
		{ file: 'assets/images/heart.svg', size: 364, type: 'image/svg+xml' },
		{ file: 'assets/images/map-pin.svg', size: 315, type: 'image/svg+xml' },
		{ file: 'assets/images/play.svg', size: 256, type: 'image/svg+xml' },
		{ file: 'assets/json/.DS_Store', size: 6148, type: null },
		{ file: 'assets/json/en/bible.json', size: 5010475, type: 'application/json' },
		{ file: 'assets/json/en/book-terms.json', size: 8876, type: 'application/json' },
		{ file: 'assets/json/es/.DS_Store', size: 6148, type: null },
		{ file: 'assets/json/es/bible.json', size: 4797217, type: 'application/json' },
		{ file: 'assets/json/es/book-terms.json', size: 5305, type: 'application/json' },
		{ file: 'browserconfig.xml', size: 246, type: 'application/xml' },
		{ file: 'favicon-16x16.png', size: 661, type: 'image/png' },
		{ file: 'favicon-32x32.png', size: 1062, type: 'image/png' },
		{ file: 'favicon.ico', size: 15086, type: 'image/vnd.microsoft.icon' },
		{ file: 'mstile-150x150.png', size: 3482, type: 'image/png' },
		{ file: 'safari-pinned-tab.svg', size: 1808, type: 'image/svg+xml' },
		{ file: 'site.webmanifest', size: 377, type: 'application/manifest+json' }
	],
...
var module_lookup = {
	...
	'src/routes/favorite.svelte': () =>
		Promise.resolve().then(function () {
			return favorite;
		}),
	'src/routes/jump.svelte': () =>
		Promise.resolve().then(function () {
			return jump;
		}),
	'src/routes/es/index.svelte': () =>
		Promise.resolve().then(function () {
			return index;
		}),
	'src/routes/es/favorita.svelte': () =>
		Promise.resolve().then(function () {
			return favorita;
		}),
	'src/routes/es/salto.svelte': () =>
		Promise.resolve().then(function () {
			return salto;
		})
};
var metadata_lookup = {
	'src/routes/__layout.svelte': {
		entry: 'pages/__layout.svelte-2ad9c63f.js',
		css: ['assets/pages/__layout.svelte-a9512a51.css'],
		js: ['pages/__layout.svelte-2ad9c63f.js', 'chunks/vendor-c74264e5.js'],
		styles: []
	},
	'.svelte-kit/build/components/error.svelte': {
		entry: 'error.svelte-faf13b73.js',
		css: [],
		js: ['error.svelte-faf13b73.js', 'chunks/vendor-c74264e5.js'],
		styles: []
	},
	'src/routes/index.svelte': {
		entry: 'pages/index.svelte-3801ed4f.js',
		css: [],
		js: ['pages/index.svelte-3801ed4f.js', 'chunks/vendor-c74264e5.js'],
		styles: []
	},
	'src/routes/favorite.svelte': {
		entry: 'pages/favorite.svelte-3eeefb93.js',
		css: [],
		js: ['pages/favorite.svelte-3eeefb93.js', 'chunks/vendor-c74264e5.js'],
		styles: []
	},
	'src/routes/jump.svelte': {
		entry: 'pages/jump.svelte-7c9cf426.js',
		css: [],
		js: ['pages/jump.svelte-7c9cf426.js', 'chunks/vendor-c74264e5.js'],
		styles: []
	},
	'src/routes/es/index.svelte': {
		entry: 'pages/es/index.svelte-4dfd42ea.js',
		css: [],
		js: ['pages/es/index.svelte-4dfd42ea.js', 'chunks/vendor-c74264e5.js'],
		styles: []
	},
	'src/routes/es/favorita.svelte': {
		entry: 'pages/es/favorita.svelte-56d3d2ff.js',
		css: [],
		js: ['pages/es/favorita.svelte-56d3d2ff.js', 'chunks/vendor-c74264e5.js'],
		styles: []
	},
	'src/routes/es/salto.svelte': {
		entry: 'pages/es/salto.svelte-a01b9ee9.js',
		css: [],
		js: ['pages/es/salto.svelte-a01b9ee9.js', 'chunks/vendor-c74264e5.js'],
		styles: []
	}
};
...
function derived(stores, fn, initial_value) {
	...
	return readable(initial_value, (set) => {
		...
		const unsubscribers = stores_array.map((store, i2) =>
			subscribe(
				store,
				(value) => {
					values[i2] = value;
...
var codePointAt = hasNativeCodePointAt
	...
	: function codePointAt3(s2, index2) {
			...
			return first < 55296 ||
				first > 56319 ||
				index2 + 1 === size ||
				(second = s2.charCodeAt(index2 + 1)) < 56320 ||
				second > 57343
				? first
...
function mergeConfig(c1, c2) {
	...
	return __assign(
		...
		Object.keys(c1).reduce(function (all, k2) {
...
var l = (e, n) => {
	if (n == null) return;
	if (n in r && e in r[n]) return r[n][e];
	const t = E(n);
	for (let o2 = 0; o2 < t.length; o2++) {
		const r2 = c(t[o2], e);
		if (r2) return i(e, n, r2);
	}
};
var a;
var s = writable({});
...
var p = {};
function b(e) {
	if (!w(e)) return e in p ? p[e] : Promise.resolve();
	const n = (function (e2) {
		return E(e2)
			.map((e3) => {
				const n2 = g(e3);
	...
	return (
		(p[e] = Promise.all(n.map(([e2, n2]) => h(e2, n2))).then(() => {
			if (w(e)) return b(e);
			delete p[e];
		})),
		p[e]
...
function v(e, n) {
	...
	if (e != null && typeof Object.getOwnPropertySymbols == 'function') {
		...
		for (o2 = Object.getOwnPropertySymbols(e); r2 < o2.length; r2++)
			n.indexOf(o2[r2]) < 0 &&
				Object.prototype.propertyIsEnumerable.call(e, o2[r2]) &&
				(t[o2[r2]] = e[o2[r2]]);
	}
	return t;
}
...
function $(e) {
	const { formats: n } = e,
		t = v(e, ['formats']),
		o2 = e.initialLocale || e.fallbackLocale;
	return (
		Object.assign(O, t, { initialLocale: o2 }),
		n &&
			('number' in n && Object.assign(O.formats.number, n.number),
			'date' in n && Object.assign(O.formats.date, n.date),
			'time' in n && Object.assign(O.formats.time, n.time)),
		M.set(o2)
	);
}
...
T.subscribe((e) => {
	(L = e != null ? e : void 0),
		typeof window != 'undefined' && e != null && document.documentElement.setAttribute('lang', e);
});
var M = Object.assign(Object.assign({}, T), {
	set: (e) => {
		if (
			e &&
			(function (e2) {
			...
			let t;
			return (
				typeof window != 'undefined' && D() != null && n
					? (t = window.setTimeout(() => k.set(true), n))
					: k.set(true),
				b(e)
					.then(() => {
						T.set(e);
...
var G = Z((e) => {
	var { locale: n, format: t } = e,
		o2 = v(e, ['locale', 'format']);
	if (n == null) throw new Error('[svelte-i18n] A "locale" must be set to format numbers');
	return t && (o2 = C('number', t)), new Intl.NumberFormat(n, o2);
});
var J = Z((e) => {
	var { locale: n, format: t } = e,
		o2 = v(e, ['locale', 'format']);
	if (n == null) throw new Error('[svelte-i18n] A "locale" must be set to format dates');
	return (
		t ? (o2 = C('date', t)) : Object.keys(o2).length === 0 && (o2 = C('date', 'short')),
		new Intl.DateTimeFormat(n, o2)
	);
});
var U = Z((e) => {
	var { locale: n, format: t } = e,
		o2 = v(e, ['locale', 'format']);
	if (n == null) throw new Error('[svelte-i18n] A "locale" must be set to format time values');
	return (
		t ? (o2 = C('time', t)) : Object.keys(o2).length === 0 && (o2 = C('time', 'short')),
		new Intl.DateTimeFormat(n, o2)
	);
});
var _ = (e = {}) => {
...
var K = (e, n = {}) => {
	...
	if (a2) {
		if (typeof a2 != 'string')
			return (
				console.warn(
					`[svelte-i18n] Message with id "${e}" must be of type "string", found: "${typeof a2}". Gettin its value through the "$format" method is deprecated; use the "json" method instead.`
				),
				a2
			);
	} else
		j().warnOnMissingMessages &&
			console.warn(
				`[svelte-i18n] The message "${e}" was not found in "${E(r2).join('", "')}".${
					w(D())
...
var Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	if ($$props.count === void 0 && $$bindings.count && count2 !== void 0) $$bindings.count(count2);
	$$unsubscribe__();
	return `<footer class="${'footer'}"><div class="${'count'}">${escape(
		$_('footer.count', { values: { count: count2 } })
	)}</div></footer>`;
});
var css$3 = {
...
var Top = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<button tabindex="${'5'}" id="${'top'}" class="${
		'top' + escape(y > 1e3 ? ' top--active' : '') + ' svelte-jrec9s'
	}">Back to top</button>`;
});
...
var Verse = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	if ($$props.index === void 0 && $$bindings.index && index2 !== void 0) $$bindings.index(index2);
	if ($$props.content === void 0 && $$bindings.content && content !== void 0)
		$$bindings.content(content);
	if ($$props.title === void 0 && $$bindings.title && title !== void 0) $$bindings.title(title);
	if ($$props.heart === void 0 && $$bindings.heart && heart !== void 0) $$bindings.heart(heart);
	if ($$props.flip === void 0 && $$bindings.flip && flip !== void 0) $$bindings.flip(flip);
	$$result.css.add(css$2);
	$$unsubscribe_locale();
	$$unsubscribe_page();
	return `<div class="${
		'verse' + escape(flip ? ' verse--flip' : '') + ' svelte-it1fg3'
	}"><div class="${'front svelte-it1fg3'}"><div class="${'front__content'}">${escape(
		content
	)}</div></div>
    <div class="${'back svelte-it1fg3'}"><div class="${'back__content'}">${
		title ? `<h3 class="${'title svelte-it1fg3'}">${escape(title)}</h3>` : ``
	}
            <div class="${'button-group'}"><button class="${'button button--back svelte-it1fg3'}">Back</button>
                <button class="${'button button--play svelte-it1fg3'}">Play</button>
                <button class="${
									'button button--' + escape(heart ? 'minus' : 'plus') + ' svelte-it1fg3'
...
var Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	function handleSearch(evt) {
		...
		const term = searchValue
			? bookTermsResponse.find(({ a: a2 }) => {
					...
					if (termLength === 1) {
						...
						const chapterVerseParts2 =
							Array.isArray(searchValue) && searchValue > 0 ? searchParts[1].split(':') : null;
						const chapterSearch2 = Array.isArray(chapterVerseParts2)
							? isNaN(parseInt(chapterVerseParts2[0], 10))
								? null
								: parseInt(chapterVerseParts2[0], 10)
							: null;
						return chapterSearch2
							? a2.toLowerCase() === searchParts[0]
							: a2.toLowerCase() === `${searchParts[0]} ${searchParts[1]}`;
					}
					return false;
			  })
			: null;
		...
		const verseRangeSearch = verseLastSearch
			? Array(verseParts[1] - 1 - (verseParts[0] - 2))
					.fill()
					.map((element, index2) => index2 + verseParts[0])
			: verseParts === null
			? null
			: verseParts;
		...
		for (let i2 = 0; i2 < items.length; i2++) {
			...
			const verseMatch = Array.isArray(verseRangeSearch)
				? verseRangeSearch.find((verseItem) => verseItem === items[i2].v)
				: null;
	...
	$$unsubscribe__();
	$$unsubscribe_page();
	return `<header class="${'header'}"><div class="${'header__content'}"><form id="${'form'}"><input tabindex="${'1'}" autocomplete="${'off'}" id="${'search'}" class="${'search'}"${add_attribute(
		'placeholder',
		placeholder,
		0
	)} type="${'search'}"></form></div>
</header>`;
});
var css$1 = {
...
var Nav = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	$$unsubscribe_json();
	$$unsubscribe_page();
	return `<nav class="${'nav svelte-f79t3i'}">${each(
		nav2,
		(item, i2) =>
			`<a class="${
				'nav__item ' +
				escape($page.path === item.path ? 'nav__item--active' : '') +
				' svelte-f79t3i'
			}"${add_attribute('href', item.path, 0)}>${escape(item.label)}</a>`
	)}
</nav>`;
});
var header$1 = {
...
<main class="${
		escape(null_to_empty(resultsCount === 0 ? 'main main--no-results' : 'main')) + ' svelte-1df0dld'
	}">${each(
		searchResults,
		(result, i2) =>
			`${validate_component(Verse, 'Verse').$$render($$result, Object.assign(result), {}, {})}`
	)}</main>
...
var Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	return `${
		(($$result.head += `${
			(($$result.title = `<title>Search a passage or Bible verse - MyBible</title>`), '')
		}`),
		'')
	}`;
});
...
var Favorite = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	return `${
		(($$result.head += `${
			(($$result.title = `<title>Search a favorite passage or Bible verse - MyBible</title>`), '')
		}`),
		'')
	}`;
});
...
var Jump = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	return `${
		(($$result.head += `${
			(($$result.title = `<title>Jump to a verse in the Bible - MyBible</title>`), '')
		}`),
		'')
	}`;
});
...
var Es = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	return `${
		(($$result.head += `${
			(($$result.title = `<title>Busque un pasaje o vers\xEDculo B\xEDblico - MyBible</title>`), '')
		}`),
		'')
	}`;
});
...
var Favorita = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	return `${
		(($$result.head += `${
			(($$result.title = `<title>Busque un pasaje o vers\xEDculo B\xEDblico favorito - MyBible</title>`),
			'')
		}`),
		'')
	}`;
...
var Salto = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	return `${
		(($$result.head += `${
			(($$result.title = `<title>Saltar a un verso de la Biblia - MyBible</title>`), '')
		}`),
		'')
	}`;
});
